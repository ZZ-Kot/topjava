...
public class MealsUtil {
    ...
    public static volatile Long mealsCount = 0L;
    private static List<MealTo> mealsTo = new ArrayList<>();

    static {
    	mealsTo.add(new MealTo(mealsCount++, LocalDateTime.of(2015, Month.MAY, 30, 10, 0), "Завтрак", 500, true));
    	mealsTo.add(new MealTo(mealsCount++, LocalDateTime.of(2015, Month.MAY, 30, 13, 0), "Обед", 1000, true));
    	mealsTo.add(new MealTo(mealsCount++, LocalDateTime.of(2015, Month.MAY, 30, 20, 0), "Ужин", 500, false));
    	mealsTo.add(new MealTo(mealsCount++, LocalDateTime.of(2015, Month.MAY, 31, 10, 0), "Завтрак", 1000, true));
    	mealsTo.add(new MealTo(mealsCount++, LocalDateTime.of(2015, Month.MAY, 31, 13, 0), "Обед", 500, true));
    	mealsTo.add(new MealTo(mealsCount++, LocalDateTime.of(2015, Month.MAY, 31, 20, 0), "Ужин", 510, false));
    }
...
//        System.out.println(getFilteredByCollector(meals, startTime, endTime, DEFAULT_CALORIES_PER_DAY));
     ...
     * Remove or fix me.
     * */
    public static void create(MealTo mealTo) {
        mealsTo.add(mealTo);
    }
