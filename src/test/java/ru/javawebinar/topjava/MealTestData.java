...
public class MealTestData {
    ...
    public static final MealTo ADMIN_MEAL3 = new MealTo(null, of(2015, Month.JUNE, 1, 14, 0), "Админ ланч", 510, true);
    public static final MealTo ADMIN_MEAL4 = new MealTo(null, of(2015, Month.JUNE, 1, 21, 0), "Админ ужин", 1500, true);
    
    public static final List<Meal> MEALS = List.of(MEAL7, MEAL6, MEAL5, MEAL4, MEAL3, MEAL2, MEAL1);
    public static final List<MealTo> ADMIN_MEALS = List.of(ADMIN_MEAL4, ADMIN_MEAL3);
